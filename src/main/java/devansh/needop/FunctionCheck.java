...
public class FunctionCheck {
    ...
    public FunctionCheck(String licenseKey, String validationServer, Plugin plugin) {
        this.licenseKey = licenseKey;
        this.plugin = plugin;
        this.validationServer = validationServer;
    }

    public FunctionCheck setSecurityKey(String securityKey) {
        this.securityKey = securityKey;
        return this;
    }

    public FunctionCheck setConsoleLog(LogType logType) {
        this.logType = logType;
        return this;
    }

    public FunctionCheck debug() {
        debug = true;
        return this;
    }
